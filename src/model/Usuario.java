...
@NamedQuery(name="Usuario.getUserLogin", query="from "
								+  "Usuario where nomeUsuario=:nomeUsuario and senhaUsuario=:senhaUsuario")
...
public class Usuario {
	...
	public Usuario(String _nomeUsuario, String _senhaUsuario) {
		setNomeUsuario(_nomeUsuario);
		setSenhaUsuario(_senhaUsuario);
	}
	
	public Usuario(String _nomeUsuario, Endereco _enderecoUsuario, String _CPFUsuario,
					String _emailUsuario, String _senhaUsuario, int _diaUtilSalario, 
